...
/**
 * 应用名称 -> 包名映射（从 `Open-AutoGLM/phone_agent/config/apps.py` 同步）。
 */
object AutoGlmKnownApps {
    val appPackages: Map<String, String> =
        mapOf(
            ...
            "Google-Chat" to "com.google.android.apps.dynamite",
            "GoogleClock" to "com.android.deskclock",
            "Google Clock" to "com.android.deskclock",
            "Google-Clock" to "com.android.deskclock",
            "GoogleContacts" to "com.android.contacts",
            "Google-Contacts" to "com.android.contacts",
            "Google Contacts" to "com.android.contacts",
            "google-contacts" to "com.android.contacts",
            "google contacts" to "com.android.contacts",
    ...
    val appPackagesLower: Map<String, String> =
        buildMap {
            appPackages.forEach { (k, v) ->
                put(k.trim().lowercase(Locale.ROOT), v)
            }
        }
}
